/*! Build 53af71ad65843e24a8ad655fe73deed70aaba0cb:1698845313548 */ ! function(e) {
    var t = {};
    ...
    }, r.p = "https://cdn.getrewardful.com/packs/", r(r.s = 81)
}({
    6: function(e, t, r) {
        var n, o, i;
        ...
        i = function() {
            ...
            return t
        }, "object" === a(t) && "undefined" !== typeof e ? e.exports = i() : void 0 === (o = "function" === typeof(n = i) ? n.call(t, r, t, e) : n) || (e.exports = o)
    },
    81: function(e, t, r) {
        "use strict";
        r.r(t);
        ...
        var l = function() {
            ...
            return t = e, n = [{
                ...
                value: function(e, t, r) {
                    ...
                    return r ? (t.cookie = a({}, r), r.expires && (r.expires = new Date(r.expires), delete t.cookie.expires), o.a.set(e, JSON.stringify(t), a(a({}, n), r))) : o.a.set(e, JSON.stringify(t), n), this.get(e)
                }
            }, {
                key: "get",
                value: function(e) {
        ...
        var w = function() {
                ...
                return t = e, n = [{
                    ...
                    value: function() {
                        var t = e.get().id;
                        return t ? this.load(t) : (console.error("Referral.update() called but there is no stored referral."), y(), !1)
                    }
                }, {
                    key: "convert",
                    value: function(t) {
                        var r = e.get().id;
                        return h("POST", x.config.API_HOST + "/referrals/".concat(r, "/convert"), t)
                    }
                }, {
                    key: "load",
                    value: function(e) {
                    ...
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            t = x.config.API_HOST + "/referrals/track";
                        return h("POST", t, e)
                    }
        ...
        var _ = function() {
            ...
            return t = e, (r = [{
                key: "referral",
                get: function() {
                    return !(!this._location || !this._location.search) && O(this._location.search, /referral=([0-9a-f]{8}-[0-9a-f]{4}-[0-5][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12})/i)
                }
            }, {
                key: "searchToken",
                get: function() {
                    return !(!this._location || !this._location.search) && O(this._location.search, /via=([a-z0-9\-]+)/i)
                }
            }, {
                key: "hashToken",
                get: function() {
                    return !(!this._location || !this._location.hash) && O(this._location.hash, /via[-=]([a-z0-9\-]+)/i)
                }
            }, {
                key: "token",
                get: function() {
        ...
        var P = function(e, t, r) {
            ...
            R = function() {
                ...
                return t = e, n = [{
                    ...
                    value: function(e) {
                        var t = {
                            referral: P(e, e.dataset.rewardfulParamName || "referral", x.referral)
                        };
                        return x.coupon && x.coupon.id && (t.coupon = P(e, "coupon", x.coupon.id)), t
                    }
                }], (r = null) && j(t.prototype, r), n && j(t, n), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), e
            }(),
            S = function() {
        ...
        var E = function() {
            ...
            return t = e, n = [{
                key: "reset",
                value: function() {
                    this._apiKey = null, this._location = !1, this._tracked = !1, this._trackComplete = !1, this._link = null, this._setup = !1, this._initialized = !1
                }
            }, {
                key: "setup",
                value: function(e) {
                    return this._setup ? (console.warn("Rewardful is already setup."), !1) : e ? e.apiKey ? e.window ? (S(), this._apiKey = e.apiKey.replace(/[^A-Za-z0-9-_]/g, ""), this._link = new _(e.window.location), this._setup = !0, this._metadata = {
                        api_key: this.apiKey,
                ...
                get: function() {
                    return {
                        timestamp: 1698845313548,
                        sha: "53af71ad65843e24a8ad655fe73deed70aaba0cb"
                    }
                }
            }, {
                key: "_cookie",
        ...
        var q = function() {
                ...
                }], r && T(t.prototype, r), n && T(t, n), Object.defineProperty(t, "prototype", {
                    writable: !1
                }), e
            }(),
            A = q;
        ! function() {
            if (window && window._rewardful_loaded) console.warn("Rewardful is already loaded.");
                ...
                try {
                    ...
                    if (e) {
                        window.Rewardful = x, x.setup({
                            apiKey: e.getAttribute("data-rewardful"),
                            window: window
                        });
                        var t = function() {
                                x.Forms.attach(), x.Links.attach({
                                    domains: e.getAttribute("data-domains"),
                                    location: window.location
                                })
                            },
                            r = new A(window, window._rwq || "rewardful", x);
